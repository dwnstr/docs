...
With this setup, the linked and off extras are almost enough to make a proper stage system. However, if you were to
press 3 to turn on stage 3 (activating stage 1 and 2 because of the `linkedExtras`) then press 2 to downgrade to stage 2, it would actually turn off all three stages since
...
and adjust it's state accordingly.
